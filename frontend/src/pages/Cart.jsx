...
const styles = {
  ...
  summary: { padding: 24, position: 'sticky', top: 100 }, summaryTitle: { fontSize: 22, marginBottom: 20 }, row: { display: 'flex', justifyContent: 'space-between', margin: '13px 0', color: 'var(--color-ink-soft)', fontSize: 13.5 }, total: { display: 'flex', justifyContent: 'space-between', borderTop: '1px solid var(--color-border)', marginTop: 20, padding: '20px 0', fontSize: 19 }, secure: { fontSize: 11, textAlign: 'center', margin: '14px 0 0' },
}
