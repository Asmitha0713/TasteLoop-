...
export default function OrderConfirmation() {
  ...
  const paymentLabel = order.payment_method === 'cash' ? 'Cash on delivery' : 'Card payment'
  return (
    <div className="page"><CustomerNav /><main className="page-content" style={styles.main}><div className="container" style={styles.inner}>
      <div style={styles.check}>✓</div><span className="eyebrow">Order confirmed</span><h1 style={styles.h1}>Your home-cooked meal is on its way!</h1><p style={styles.lead}>Your order has been received and will be prepared shortly.</p>
      <div className="card" style={styles.card}><div style={styles.top}><div><small>ORDER NUMBER</small><strong>#{order.order_number}</strong></div><span className="stitched">Confirmed</span></div><div style={styles.timeline}><div style={styles.line}><span style={styles.fill} /></div><div style={styles.steps}><div><b>✓</b><strong>Confirmed</strong><small>Now</small></div><div><b>2</b><strong>Preparing</strong><small>Starts soon</small></div><div><b>3</b><strong>On the way</strong><small>After preparation</small></div><div><b>4</b><strong>Delivered</strong><small>Final step</small></div></div></div>
