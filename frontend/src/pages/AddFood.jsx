          ...
          <form className="food-form" onSubmit={submit} noValidate>
            ...
            <section className="card form-section">
              ...
              <div className="form-grid">
                ...
                <label className="food-field"><span>Category *</span><select name="category" value={form.category} onChange={update} aria-invalid={!!errors.category}><option value="">Select a category</option><option>Breakfast</option><option>Lunch</option></select>{errors.category && <small className="form-error">{errors.category}</small>}</label>
