  ...
  return (
    <header className="cook-nav">
      <div className="container cook-nav__bar">
        ...
        <div className="cook-profile"><span className="cook-profile__avatar">NP</span><span className="hide-mobile"><strong>Nadeesha</strong><small>Home cook</small></span></div>
      </div>
    </header>
  )
}
